...
envaic() {
  ...
  AIC_DIR=/root/aic
  AIC=${AIC_DIR}/aic
  AAPT=/root/gaming/ACGSS_SG1_LR_LT_4.2_PV1.2_RC2_c7.4_k4.14.105_10118/tools/aapt
...
colib_i915_avg() {
  ...
  END {
    printf ("%-23s %-15s %-15s %-15s %-15s %-15s\n", "  Total_avg",ren/(NR-1),vid/(NR-1),vide/(NR-1),vide2/(NR-1),fre/(NR-1))
  }
